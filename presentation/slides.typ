...
#slide[
  = Усредённая эффективность подходов
  #set text(size: 14pt)
  #table(
    columns: (5cm, 2.5cm, 2.5cm, 3cm, 4cm, 4cm, 8cm),
    inset: 6pt,
    stroke: 0.4pt,
    align: (x, y) => if x == 0 { left } else { center },

    [*Подход*], [*Скорость*], [*Память*], [*Сложность поддержки*], [*Градиент*], [*Гессиан*], [*Когда брать*],

    [Ручная аналитика, глобальная формула],
    [1],
    [1],
    [5],
    [точный],
    [точный],
    [Когда блок маленький, стабильный, и нужен максимум raw performance.],

    [Ручная аналитика, локальные правила + chain rule],
    [2],
    [1],
    [2],
    [точный],
    [точный],
    [Лучший инженерный баланс для статического pipeline из небольших блоков.],
    ...
    [точный AD],
    [точный AD],
    [Когда хочется меньше ручной математики, но сохранить высокий performance.],
    ...
    [точный AD],
    [точный AD],
    [Когда параметров мало или умеренно мало, и важна простота кода.],
    ...
    [точный AD],
    [можно, но тяжелее],
    [Хорошо для больших моделей со scalar loss, не лучший выбор для маленького fixed block.],
    ...
    [приближённый],
    [приближённый],
    [Только как fallback, baseline или проверка аналитики/AD.],
  )
